  ...
  useEffect(() => {
    const loadTopCartoons = async () => {
      ...
      try {
        ...
        setError(
          "Помилка завантаження топ мультфільмів. Перевірте токен або інтернет."
        );
        setAllItems([]);
        setDisplayItems([]);
      } finally {
      ...
      <div className="container mx-auto px-4 py-12 max-w-7xl">
        ...
        {searchMode && (
          <div className="text-center mb-8">
            ...
            >
              ← Повернутись до топ мультфільмів
            </button>
          </div>
        )}
        ...
        <form onSubmit={searchCartoons} className="max-w-3xl mx-auto mb-16">
          <div className="flex flex-col sm:flex-row gap-4">
            <input
              ...
              placeholder="Шукати мультфільми: Король Лев, Холодне серце, Шрек, Вгору, Мадагаскар, Тачки..."
